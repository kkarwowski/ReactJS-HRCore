...
const UploadToFirebase = (testimage) =>{
  // const uploadTask = storage.ref(`images/dfdf.jpg`).put(testimage);
  const storage = getStorage();
  const storageRef = ref(storage, 'associateImages/dfgdf.jpg');
...
const [image, setImage] = React.useState(null);
  ...
  return (
    <div>
      ...
      <Button variant="contained" onClick={UploadToFirebase}>Upload to firebase</Button>
